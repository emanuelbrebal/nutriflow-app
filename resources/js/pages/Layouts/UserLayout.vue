<template>
  <div class="min-h-screen flex ">
    <aside class="w-64 bg-white border-r-4 border-[#5AD598] text-black p-[24px] pdl-4 flex flex-col justify-content-evenly">
      ...
      <div class="flex-1 flex flex-col bg-[#e2e2e2]">
